...
public class IndexerSettingsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (type) {
            ...
            case thumbnailSize:
                ...
                break;
            case watcher:
                ServerSettingsManager.getSettings().getArchiveSettings()
                        .setDirectoryWatcherEnabled(Boolean.parseBoolean(param));
                break;
            case all:
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (type) {
            ...
            case watcher:
                result = String
                        .valueOf(ServerSettingsManager.getSettings().getArchiveSettings().isDirectoryWatcherEnabled());
                break;
            case all:
                ...
                allresponse.put("thumbnail",
                        ServerSettingsManager.getSettings().getArchiveSettings().getSaveThumbnails());
                allresponse.put("thumbnailSize",
                        String.valueOf(ServerSettingsManager.getSettings().getArchiveSettings().getThumbnailSize()));
                allresponse.put("watcher",
                        ServerSettingsManager.getSettings().getArchiveSettings().isDirectoryWatcherEnabled());
