...
public class SettingsServlet extends HttpServlet {
    ...
    public static final String ACTION_SET_SOP_CLASS_GLOBAL_TRANSFER_STORAGE_SETTINGS =
            "settransferstorageglobalsettings";
    ...
    public HashMap<String, Object> getAccessListSettings() {
        ...
        settings.put(SETTING_PERMIT_ALL_AE_TITLES_NAME,
                new Boolean(cfg.getDicomServicesSettings().getAllowedAETitles().isEmpty()));
    ...
    public Object[] getTransferSettingsForAllSOPClasses() {
        ...
        // get the first SOP Class UID // FIXME using the first SOP Class settings as global does not accurately represent the common settings for all SOP
        // classes, but it's close enough (if they get applied :) )
