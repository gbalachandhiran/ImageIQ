...
public class Session {
     ...
     */
    public static LoggedIn servletLogin(HttpServletRequest request, HttpServletResponse response,
            boolean requiresAdminRights) throws IOException {
            ...
            if (requiresAdminRights) {
                if (login.isAdmin())
                    ...
                    response.sendError(HttpServletResponse.SC_UNAUTHORIZED,
                            "Administrator rights are needed to process this request!");
                    return null;
                }
            } else
                return login;
     ...
     * @return a LoggedIn object if the request is to be served, null otherwise.
     */
    public static LoggedInStatus webappLogin(HttpServletRequest request, HttpServletResponse response,
            boolean requiresAdminRights) throws IOException {
        // check if there a session and a login information attached to it
