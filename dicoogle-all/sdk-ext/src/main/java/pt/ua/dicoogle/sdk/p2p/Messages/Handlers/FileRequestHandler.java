...
public class FileRequestHandler implements MessageHandler, Observer {
    ...
    public void update(Observable o, Object arg) {
        ...
        if (TaskRequest.class.isInstance(o)) {
            ...
            if ((parameters.get(TaskRequestsConstants.P_REQUESTER_ADDRESS) != null)
                    && (results.get(TaskRequestsConstants.R_SEARCH_RESULTS) != null)
                ...
                NPA.sendFile(sr.getURI().toString(),
                        (String) parameters.get(TaskRequestsConstants.P_REQUESTER_ADDRESS));
