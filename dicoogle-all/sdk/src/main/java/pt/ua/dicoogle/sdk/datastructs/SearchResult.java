...
public class SearchResult implements Serializable {
     ...
     */
    public static HashMap<String, HashMap<String, HashMap<String, HashMap<String, SearchResult>>>> toTree(
        ...
        for (SearchResult r : results) {
            ...
            if (studyUID == null)
                studyUID = "undefined StudyInstanceUID";
            else {
                studyUID = studyUID.trim();
            }

            if (seriesUID == null)
                seriesUID = "undefined SeriesInstanceUID";
            else {
