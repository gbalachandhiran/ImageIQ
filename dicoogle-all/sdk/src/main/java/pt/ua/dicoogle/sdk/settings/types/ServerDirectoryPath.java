...
public class ServerDirectoryPath implements GenericSetting {
    ...
    public synchronized String toHTMLString(String htmlElementID) {
        ...
        result += "<input class=\"span4\" type=\"text\" id=\"" + htmlElementID + "\" name=\"" + htmlElementID
                + "\" value=\"" + path + "\" />";
        result += "<button type=\"button\" class=\"btn\" onclick=\"showDirList(document.getElementById('"
                + htmlElementID + "ds'), document.getElementById('" + htmlElementID + "'), this);\">";
